...
from utils.context import raise_MPI_error
...
if __name__ == "__main__":
    ...
    with raise_MPI_error():
        ...
        # print(args.dataset)
        # print(args.data_dir)
        # print(args.partition_method)
        # print(args.partition_alpha)
        # print(args.client_num_in_total)
        # print(args.client_num_per_round)
        # print(args.batch_size)
        # print(args.client_optimizer)
        # print(args.backend)
        # print(args.lr)
        # print(args.wd)
        # print(args.epochs)
        # print(args.comm_round)
        # print(args.is_mobile)
        # print(args.frequency_of_the_test)
        # print(args.gpu_server_num)
        # print(args.gpu_mapping_file)
        # print(args.gpu_mapping_key)
        print(args.grpc_ipconfig_path)
        # print(args.ci)
        logging.info(args)
